...
class NewFollowersRepositoryImpl extends NewFollowersRepository {
  ...
  @override
  Future<ResponseNewFollowersModel?> getNewFollowers() async {
    try {
      final request = await _api.post(Endpoint.GET_FOLLOWER_NOTIFICATIONS);
  ...
  @override
  Future<SuggestedUserModel?> getSuggestedUsers() async {
    try {
      final request = await _api.post(Endpoint.GET_SUGGESTED_USERS);
